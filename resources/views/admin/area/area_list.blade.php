...
@section('content')
      ...
      <div class="card">
        ...
        <div class="pull-right" style="margin-bottom: 14px;">
                        <a class="btn btn-outline-success btn-fw" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus-circle"></i> Create New Area</a>
      </div>
                ...
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$make_list->city_name->name}}</td>
                        <td>
                        ...
                        <td style ="width: 20%;">
                          <!-- <a href="{{url('lookup/area-view')}}/{{$make_list->id}}" class="btn btn-sm btn-outline-primary">View</a> -->
                          {{-- <a onclick="getdata('{{$make_list->id}}','{{$make_list->name}}','{{$make_list->status}}','{{$make_list->city_id}}')" class="btn btn-sm btn-outline-success" data-toggle="modal"  data-target="#exampleModal3"> View</a> --}}

                          <!-- <a href="{{url('lookup/area-edit')}}/{{$make_list->id}}" class="btn btn-sm btn-outline-success">Edit</a> -->

                          <a onclick="getInfo('{{$make_list->id}}','{{$make_list->name}}','{{$make_list->status}}','{{$make_list->city_id}}')" class="btn btn-sm btn btn-outline-warning" data-toggle="modal"  data-target="#exampleModal2">Edit</a>

                          <a href="{{url('lookup/area-delete')}}/{{$make_list->id}}" class="btn btn-sm btn-outline-danger">Delete</a>
                        </td>
                    </tr>
                   @endforeach
                  </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('area-store')}}" method="post"
              ...
              <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Select City *</label>
                  <div class="col-sm-9">
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{route('area-edit-store')}}" method="post"
                      enctype="multipart/form-data">
                      @csrf
              ...
              <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Select City *</label>
                  <div class="col-sm-9">
                      <select required class="form-control" id="formMake" name="city_id" >
