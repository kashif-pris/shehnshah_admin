...
@section('content')
      ...
      <div class="card">
        ...
        <div class="pull-right" style="margin-bottom: 14px;">
                        <a class="btn btn-outline-success btn-fw" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus-circle"></i> Create New Make</a>
                    </div>
            <!-- <div class="row pb-3">
                ...
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td style ="width: 20%;">
                          <!-- <a href="{{url('lookup/make-view')}}/{{$make_list->id}}" class="btn btn-sm btn-outline-primary">View</a> -->
                          ...
                          <!-- <a href="{{url('lookup/make-edit')}}/{{$make_list->id}}" class="btn btn-sm btn-outline-success">Edit</a> -->
                          <a onclick="getInfo('{{$make_list->id}}','{{$make_list->name}}','{{$make_list->status}}')" class="btn btn-sm btn-outline-warning" data-toggle="modal"  data-target="#exampleModal2"> Edit</a>
                          <a href="{{url('lookup/make-delete')}}/{{$make_list->id}}" class="btn btn-sm btn-outline-danger">Delete</a>
                        </td>
                    </tr>
                   @endforeach
                  </tbody>
